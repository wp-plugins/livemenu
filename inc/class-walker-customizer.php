 ...
 * @uses Walker
 */
class livemenu_customizer_walker extends Walker {
    ...
    * Constructor
   **/
   public function __construct( $menu_config, $DBconfig, $menu_id ) {
      $this->lm_menu_config = $menu_config;
   ...
   **/
   function lm_get_item_class( $item, $item_meta, $depth ){
      ...
      // Live Builder Re-order class
      $item_class_names .= ' lm-item-reorder';
   ...
   function lm_get_item_link( $item, $item_meta, $depth ){
      ...
      $item_cus_output = '
         <div class="lm-controls">
            <a data-menu_id="'.$this->lm_menu_config['menu_id'].'" data-menu_class="'.$this->lm_menu_config['menu_class'].'" data-item_id="'.$item->ID.'" data-page="menu_add_items">'
               .__('Add Sub Item','era_fw').
            '</a>
            <a data-menu_id="'.$this->lm_menu_config['menu_id'].'" data-menu_class="'.$this->lm_menu_config['menu_class'].'" data-item_id="'.$item->ID.'" data-item_depth="'.$depth.'" data-item_type="'.$this->lm_submenu_type.'" data-page="menu_edit_item">'
               .__('Edit','era_fw').
            '</a>
            <a data-menu_id="'.$this->lm_menu_config['menu_id'].'" data-menu_class="'.$this->lm_menu_config['menu_class'].'" data-item_id="'.$item->ID.'" data-page="item_remove">'
               .__('Remove','era_fw').
            '</a>
            <a data-menu_id="'.$this->lm_menu_config['menu_id'].'" data-menu_class="'.$this->lm_menu_config['menu_class'].'" data-item_id="'.$item->ID.'" data-submenu="'.$depth.'" data-page="item_style">'
               .__('Style','era_fw').
            '</a>
            <span class="era-icon era-icon-chevron-thin-down"></span>
         </div>';

      /*** all together ***/
      $item_output  = $item_cus_output . '<a '. $atts_output .'>';
      $item_output .= '<div class="era-icon '.$arrows_output.@$item_meta['lm-op-icon'][0].'">
                        '.$item_title.$responsive_arrow.'
                        </div>';
      $item_output .= '</a>';
